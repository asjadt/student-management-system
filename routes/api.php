...
Route::middleware(['custom.auth', "business.subscription.check"])->group(function () {
    ...
    Route::controller(TeacherController::class)->group(function () {
        Route::get('/v1.0/teacher-courses', 'getTeacherCourses');
        Route::get('/v1.0/teachers', 'getTeachers');
        Route::get('/v1.0/teachers/{id}', 'getTeacherById');
        Route::post('/v1.0/teachers', 'createTeacher');
        Route::put('/v1.0/teachers', 'updateTeacher');
        Route::delete('/v1.0/teachers/{ids}', 'deleteTeachersByIds');
    });
    //
