...
class CreateSettingUnpaidLeaveStudentStatusesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('unpaid_leave_student_statuses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('setting_unpaid_leave_student_statuses');
    }
}
