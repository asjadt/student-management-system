...
class DynamicMail extends Mailable
{
   ...
   private $type;
    ...
    public function build()
    {
        ...
        $html_content =  str_replace("[business_admin_FirstName]", $this->data->business->owner->first_Name, $html_content );
        $html_content =  str_replace("[business_admin_LastName]", $this->data->business->owner->last_Name, $html_content );
        $html_content =  str_replace("[business_admin_FullName]", ($this->data->business->owner->first_Name. " " .$this->data->business->owner->last_Name), $html_content );
