...
class DynamicMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $html_content =  str_replace("[college_owner_FirstName]", $this->data->business->owner->first_Name, $html_content);
        $html_content =  str_replace("[college_owner_LastName]", $this->data->business->owner->last_Name, $html_content);
        $html_content =  str_replace("[college_owner_FullName]", ($this->data->business->owner->first_Name . " " . $this->data->business->owner->last_Name), $html_content);
