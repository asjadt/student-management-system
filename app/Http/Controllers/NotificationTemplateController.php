...
class NotificationTemplateController extends Controller
{
     ...
     *  @OA\RequestBody(
     *         required=true,
     *  description="use [customer_name],[college_owner_name],[business_name],
    ...
    public function getNotificationTemplateTypes(Request $request)
    {
        try {
            ...
            $types = [
                ...
                "bid_created_by_college_owner",
                "bid_updated_by_college_owner",
                "bid_accepted_by_client",
                "bid_rejected_by_client",

                "booking_created_by_college_owner",
                "booking_updated_by_college_owner",
                "booking_status_changed_by_college_owner",
                "booking_confirmed_by_college_owner",
                "booking_deleted_by_college_owner",
                "booking_rejected_by_college_owner",
                ...
                "job_created_by_college_owner",
                "job_updated_by_college_owner",
                "job_status_changed_by_college_owner",
                "job_deleted_by_college_owner",
            ];
