...
class TeacherController extends Controller
{
    ...
    public function getTeachers(Request $request)
    {
        try {
            ...
            $teachers = Teacher::where('teachers.business_id', auth()->user()->business_id)
     ...
     *      summary="This method is to get teacher courses  ",
     *      description="This method is to get teacher courses ",
     *
    ...
    public function getTeacherCourses(Request $request)
    {
        try {
            ...
            // GET TEACHER COURSES
            $teacher_courses = CourseTitle::with(['sessions' => function ($query) {
