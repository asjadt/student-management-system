...
trait BusinessUtil
{
    ...
    public function checkManager($id)
    {
        ...
        if (!$user->hasRole(("business_owner" . "#" . auth()->user()->business_id))) {
            return [
                "ok" => false,
                "status" => 403,
    ...
    public function checkEmployees($ids)
    {
        ...
        foreach ($users as $user) {
            ...
            if (!$user->hasRole(("business_owner" . "#" . auth()->user()->business_id)) && !$user->hasRole(("business_owner" . "#" . auth()->user()->business_id)) &&  !$user->hasRole(("business_employee" . "#" . auth()->user()->business_id))) {
                return [
                    "ok" => false,
                    "status" => 403,
